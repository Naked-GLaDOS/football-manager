...
import { IconPlayers, IconStaff, IconParents, IconMatches, IconOpponents, IconTrainings, IconAdmin, IconSettings, IconGlobe, IconLogout, IconUser, IconLock } from './Icons';

export type View = 'players' | 'staff' | 'genitori' | 'matches' | 'avversari' | 'trainings' | 'settings' | 'cms';
...
const NAV: { view: View; key: TKey; Icon: React.FC<{ size?: number }>; adminOnly?: boolean }[] = [
  ...
  { view: 'avversari', key: 'opponents', Icon: IconOpponents },
